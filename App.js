...
import {  StyleSheet, Text, View, ScrollView, Image, TextInput, Button, TouchableOpacity, Platform, ImageBackground } from 'react-native';
...
<ScrollView>
 <Text style={[styles.textsty]}>Horizontal Section</Text>
      ...
      <View style={[styles.thirdContainer]}>
       ...
       <TextInput placeholder = "placeholder" style={[styles.textInputstyle]}></TextInput>
...
<View style={{flex:1}}>
    <Button style={{height:40,justifyContent:'center'}} title="button" color="lightgreen"  />
    </View>

    <View style={{flex:1}}>
    <TouchableOpacity style={{backgroundColor:'transparent',marginRight:20,alignItems: "center",padding: 10}}>
      <Text style={{alignSelf:'center',color:'lightgreen'}}>button</Text>
    </TouchableOpacity>
    </View>
    ...
    <View style={{backgroundColor:'lightgreen',flex:0.7,padding:20}}>
    </View>
    </View>

    <Text style={[styles.textsty]}>mix row and column flex</Text>

<View style={{backgroundColor:'lightgray',flex:1,marginTop:10,padding:20}}>
<View style={{backgroundColor:'#9C9C9C',flex:1,flexDirection:'column'}}>
<View style={{flex:1,flexDirection:'row'}}>
<View style={{backgroundColor:'white',height:44,width:40}}/>
<View style={{flex:1,flexDirection:'column'}}>
<View style={{flex:1,height:22,justifyContent:'center',padding:8}}>
<Text style={[styles.smalltextsty]}>   user name</Text>
</View>
<View style={{backgroundColor:'#848484',flex:1,height:20,justifyContent:'center',padding:8}}>
<Text style={[styles.smalltextsty]}>   3 mins ago</Text>
</View>
</View>
</View>
<Text style={[styles.smalltextsty,{padding:8}]}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</Text>
</View>
</View>

<Text style={[styles.textsty]}>Relative position training</Text>

<View style={{backgroundColor:'lightgray',flex:1,height:180,marginTop:10}}>
...
<View style={{right:'50%',bottom:0,position:'absolute',marginBottom:10}}>
...
<ImageBackground source={require('./assets/test.png')} resizeMode="cover" style={{flex: 1,justifyContent: "center",padding:100,marginTop:10}}>
      <Button title="Join Us" style={{backgroundColor:'transparent'}}></Button>
</ImageBackground>
